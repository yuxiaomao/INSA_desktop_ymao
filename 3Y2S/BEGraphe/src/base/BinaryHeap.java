...
public class BinaryHeap<E extends Comparable<E>> {
	 ...
	 * 
	 * @param e
	 * @return index du Element dans le tas, -1 si not trouve
	 */
	public int existe(E e){
	 ...
	 * 
	 * @param e
	 * si e existe dans le tas, update
	 * si e n'existe pas dans le tas, insere
	 */
	public void updateOrInsert(E e){
		int index =  this.array.indexOf(e);
		if (index != -1){
			this.percolateUp(index);
