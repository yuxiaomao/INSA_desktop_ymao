...
public class Launch {
	...
	public void go() {
		...
		try {
			...
			/* test unitaire sommet */
			System.out.println("Nombre moyen arc=" + graphe.testMoyenArc());
			...
			while (continuer) {
				...
				case 6:
					algo = new PccCov(graphe, this.fichierSortie(),
							this.readarg);
					break;
					
				case 7:
					algo = new TestAuto(graphe, this.fichierSortie(),
							this.readarg);
					break;
