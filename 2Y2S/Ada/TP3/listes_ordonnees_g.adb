...
package body Listes_Ordonnees_G is
   ...
   function Liste_To_String(L: in Une_Liste_Ordonnee) return String is
      --il n'y a que liste_to_string connait ce function.. 
      --mais pas lien_to_string
      --donc declaration à l'intérieur
   ...
   procedure Copier(L1:in Une_Liste_Ordonnee; L2:out Une_Liste_Ordonnee) is
   begin
